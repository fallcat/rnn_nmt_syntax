    ...
    def search_sequential_batch(self, sequences, topv, topi, scores, hiddens, batch_size):
        ...
        for s in range(self.config['span_size']):
            ...
            if s == 0:
                ...
                # print("i = 1, j = 2")
                # print("a_matrix", a_matrix[2, 1])
                # print("b_matrix", b_matrix[2, 1])
                # print("c_matrix", c_matrix[2, 1])
                # print("d_matrix", d_matrix[0][2, 1])
                # print("d_matrix", d_matrix[0].size())
                # print("i = -1, j = -1")
                ...
                if s == 1:
                    print("i = 0, j = 0")
                    print("b_matrix prev", b_matrix[0, 0])
                    print("topi[a_matrix, s, colsi] prev", topi[a_matrix, s, colsi][0, 0])
                    print("i = 1, j = 2")
                    print("b_matrix prev", b_matrix[2, 1])
                    print("topi[a_matrix, s, colsi] prev", topi[a_matrix, s, colsi][2, 1])
                    print("i = -1, j = -1")
                    print("b_matrix prev", b_matrix[-1, -1])
                    print("topi[a_matrix, s, colsi] prev", topi[a_matrix, s, colsi][-1, -1])
                print("-------------")
